        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiftCardPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_GiftCards_GiftCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedStoreStoreId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartItems", x => x.ShoppingCartItemId);
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_GiftCards_GiftCardId",
                        column: x => x.GiftCardId,
                        principalTable: "GiftCards",
                        principalColumn: "GiftCardId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_Stores_SelectedStoreStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_GiftCardId",
                table: "OrderDetails",
                column: "GiftCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_GiftCardId",
                table: "ShoppingCartItems",
                column: "GiftCardId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_SelectedStoreStoreId",
                table: "ShoppingCartItems",
